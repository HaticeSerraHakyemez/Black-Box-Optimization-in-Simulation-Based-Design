...
class ActiveLearning:
    def __init__(self, initial_points, initial_values, model, sampling_strategy, num_iterations=50, tolerance=0.15):
    ...
    def run_active_learning(self, num_samples, ranges, k):
        ...
        return  {"min_function_values": min_function_values, "improvement": improvement, "new_points_all": new_points_all, "iteration": iteration}
