...
def langermann(x, a=[3, 5, 2, 1, 7, 9, 4, 6, 8]):
    m, n = len(a), len(x)
    c = np.pi * np.array([1, 2, 1, 2, 1, 2, 1, 2, 1])
    A = np.array([[3, 5, 2, 1, 7, 9, 4, 6, 8],
                  [5, 2, 1, 7, 9, 4, 6, 8, 3],
                  [2, 1, 7, 9, 4, 6, 8, 3, 5],
                  [1, 7, 9, 4, 6, 8, 3, 5, 2],
                  [7, 9, 4, 6, 8, 3, 5, 2, 1],
                  ...
                  [6, 8, 3, 5, 2, 1, 7, 9, 4],
                  [8, 3, 5, 2, 1, 7, 9, 4, 6]])
    return -np.sum([c[i] * np.exp(-np.sum((x - A[i])**2)) for i in range(m)])
